...
@section('content')
    <div class="container">
        <a href="/fleet/add" class="btn btn-primary float-right"> <i class="fa fa-plus" aria-hidden="true"></i> Add
            Fleet</a>
        <h3>Fleet</h3>
        <div class="card mt-3">
            <div class="card-body">
                ...
                <form action="/fleet">
                        ...
                        <div class="col-sm-12 col-md-3 mt-3">
                            <div class="form-group">
                                ...
                                <input value="{{ request()->get('name') ?? '' }}" type="text" class="form-control"
                                    name="name" id="name" placeholder="Enter Fleet Name">
                            </div>
                        </div>
                        <div class="col-sm-12 col-md-3 mt-3">
                            <div class="form-group">
                                <label for="code">Fleet Code</label>
                                <input value="{{ request()->get('code') ?? '' }}" type="text" class="form-control"
                                    name="code" id="code" placeholder="Enter Fleet Code">
                            </div>
                        </div>
                        <div class="col-sm-12 col-md-3 mt-3">
                            ...
                            <select class="custom-select" id="status" name="status">
                                ...
                                <option @if (request()->get('status') == 0) selected @endif value="0">Available</option>
                                <option @if (request()->get('status') == 1) selected @endif value="1">Maintanances</option>
                            </select>
                        </div>
                    ...
                    <div class="d-flex justify-content-end mt-2">
                        <a href="/fleet" class="btn btn-outline-dark mr-2">Clear</a>
        ...
        <div class="card mt-4 text-dark">
            <div class="card-body">
                ...
                <div class="d-flex justify-content-end mt-2">
                    {{ $data->appends(['code' => request()->get('code') ?? '', 'name' => request()->get('name') ?? '','status' => request()->get('status') ?? 0, 'ordid' => request()->get('ordid') ?? 0])->links() }}
                </div>
            </div>
        </div>
    @endsection
