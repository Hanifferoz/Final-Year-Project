...
<div class="container">
    ...
    <div class="card">
        <div class="card-body">
            <form action="/fleet/add" method="POST"> @csrf
                <div class="row">
                    <div class="col-sm-12 mt-3 col-md-6">
                        <div class="form-group">
                            <label for="name">Name <span class="text-danger"></span></label>
                            <input type="text" class="form-control" required value="{{ old('name') }}" name="name" id="name" placeholder="Enter Name">
                            @if($errors->has('name'))
                    ...
                    <div class="col-sm-12 mt-3 col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" required value="{{ old('code') }}" name="code" id="code" placeholder="Enter Flight Code">
                            @if($errors->has('code'))
                    ...
                    <div class="col-sm-12 mt-3 col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" required value="{{ old('seats') }}" name="seats" id="seats" placeholder="Enter Seats">
                            @if($errors->has('seats'))
                        ...
                        <div class="form-group">
                            <label for="status"> Status <span class="text-danger"></span></label>
                              <select class="form-control" name="status" id="status">
                                <option @if(old('status')==0) selected @endif value="0">Available</option>
                                <option @if(old('status')==1) selected @endif value="1">Maintananced</option>
                              </select>
                        ...
                        <div class="form-group">
                            <label for="curstatus"> Curent Status <span class="text-danger"></span></label>
                              <select class="form-control" name="curstatus" id="curstatus">
                                <option @if(old('curstatus')==0) selected @endif value="0">Parked</option>
                                <option @if(old('curstatus')==1) selected @endif value="1">Flying</option>
                              </select>
