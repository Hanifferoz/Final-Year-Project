...
<div class="container">
    ...
    <div class="card">
        <div class="card-body">
            <form action="/routes/add" method="POST"> @csrf
                <div class="row">
                            ...
                            <label for="fid"> From Airport <span class="text-danger"></span></label>
                              <select class="form-control" name="fid" id="fid">
                                    @for($i=0;$i<$airport->count();$i++)
                                        <option @if(old('fid')==$airport[$i]->id) selected @endif value="{{ $airport[$i]->id }}">{{ $airport[$i]->name }}- {{ $airport[$i]->code }}</option>
                                    @endfor
                              </select>
                            @if($errors->has('fid'))
                        ...
                        <div class="form-group">
                            <label for="tid"> To Airport <span class="text-danger"></span></label>
                              <select class="form-control" name="tid" id="tid">
                                    @for($i=0;$i<$airport->count();$i++)
                                        <option @if(old('tid')==$airport[$i]->id) selected @endif value="{{ $airport[$i]->id }}">{{ $airport[$i]->name }}- {{ $airport[$i]->code }}</option>
                                    @endfor
                              </select>
                            @if($errors->has('tid'))
                    ...
                    <div class="col-sm-12 mt-3 col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" required value="{{ old('distance') }}" name="distance" id="distance" placeholder="Enter Distance">
                    ...
                    <div class="col-sm-12 mt-3 col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" required value="{{ old('netmaincost') }}" name="netmaincost" id="distance" placeholder="Enter Net Resource Cost">
                    ...
                    <div class="col-sm-12 mt-3 col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" required value="{{ old('travelcost')??0 }}" name="travelcost" id="travelcost" placeholder="Enter Fuel Cost">
