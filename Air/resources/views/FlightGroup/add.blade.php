...
<div class="container">
    ...
    <div class="card">
        <div class="card-body">
            <form action="/flightgroup/add" method="POST"> @csrf
                <div class="row">
                    <div class="col-sm-12 mt-3 col-md-6">
                        <div class="form-group">
                            <label for="name">Flight Group Name <span class="text-danger"></span></label>
                            <input type="text" class="form-control" required value="{{ old('name') }}" name="name" id="name" placeholder="Enter Flight Group Name">
                            @if($errors->has('name'))
                    ...
                    <div class="col-sm-12 mt-3 col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" required value="{{ old('code') }}" name="code" id="code" placeholder="Enter Flight Group Code">
                            @if($errors->has('code'))
